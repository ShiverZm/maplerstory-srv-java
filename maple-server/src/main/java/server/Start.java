...
import com.ruoyi.web.bootstrap.WebModuleBootstrap;
...
//        CashGui();
    ...
    private static void startAdminWebServer() {
        try {
            WebModuleBootstrap.start();
        } catch (Exception ex) {
            System.out.println("[WebAdmin] 启动异常: " + ex.getMessage());
        }
    }
